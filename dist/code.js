...
/* harmony export */   calculateIntersection: () => (/* binding */ calculateIntersection),
/* harmony export */   getCorners: () => (/* binding */ getCorners),
/* harmony export */   getGradientPoints: () => (/* binding */ getGradientPoints),
/* harmony export */   htmlColor: () => (/* binding */ htmlColor),
/* harmony export */   numToAutoFixed: () => (/* binding */ numToAutoFixed),
/* harmony export */   rotate: () => (/* binding */ rotate),
/* harmony export */   rotateElipse: () => (/* binding */ rotateElipse),
/* harmony export */   round: () => (/* binding */ round)
/* harmony export */ });
/* harmony import */ var _figma_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @figma-plugin/helpers */ "./node_modules/.pnpm/@figma-plugin+helpers@0.15.2/node_modules/@figma-plugin/helpers/dist/index.js");
 ...
 * @returns 旋转后的椭圆坐标
 */
function rotateElipse(cx, cy, xRadius, yRadius, angle, rotationFactor) {
 ...
 * @returns 四个角坐标
 */
function getCorners(node, elemRotation) {
 ...
 * @returns 渐变点绝对坐标
 */
function getGradientPoints(topLeftCorner, pointRelativeCoords, shapeCenter, elemRotate) {
...
figma.ui.onmessage = async ({ id, type, payload = {} }) => {
  try {
    ...
    if (node.fills.length) {
      ...
      console.log(_figma_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__.extractLinearGradientParamsFromTransform, 'extractLinearGradientParamsFromTransform')
      const { start: startRatio, end: endRatio } = (0,_figma_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__.extractLinearGradientParamsFromTransform)(1, 1, fill.gradientTransform)
